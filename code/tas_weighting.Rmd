---
title: Weighting tas by historical behaviour
output: html_document
---

```{r}
# Weight CMIP6 model projection s based on historical data.
...
```{r}
# A better bootsrapping technique is to create a large number of 
# samples, each the same size as the models. This gives you an estimate
# of the mean (and the sampling uncertainty of that mean).
